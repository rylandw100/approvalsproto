...
export function TopBar() {
  return (
    <div className="bg-white border-b border-gray-200 h-14 flex items-center justify-between px-5">
      ...
      <div className="flex items-center justify-between flex-1 h-full">
        <div className="bg-gray-100 relative w-[600px] rounded-lg px-3 py-2 flex items-center gap-2">
          <Search className="h-5 w-5 text-gray-600" />
          <Input 
            placeholder="Search or jump to..."
            className="border-0 bg-transparent text-sm placeholder:text-gray-600"
          />
        </div>
